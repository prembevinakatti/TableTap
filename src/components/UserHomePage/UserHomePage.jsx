  ...
  return (
    <div>
      ...
      <div className="UserHome">
        <div className="HomenavBtns m-2 flex items-center gap-10">
          <div>
        ...
        <div className="homeContent w-full h-[70vh] overflow-auto   ">
          <div className="flex flex-wrap items-center justify-center w-full my-3 h-full gap-10 rounded-lg p-5">
            <div className="HomeBox flex flex-col items-start  w-1/4 h-[55vh] rounded-lg p-4 border m-3 shadow-lg">
