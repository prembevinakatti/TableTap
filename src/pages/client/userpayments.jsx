...
function Userpayments() {
  ...
  return (
    <div className="p-6 bg-gray-100 relative">
      <h1 className="text-2xl font-bold mb-6 text-center text-gray-800">your Payments</h1>
            ...
            <div key={payment.$id} className="bg-white p-6 rounded-lg shadow-md">
              <div className="mb-4">
                <p className="text-lg text-gray-700">
                  To: <span onClick={() => navigate(`/resprofilepage/${payment.resid}`)} className="text-blue-500 cursor-pointer">{payment.userid}</span>
                </p>
