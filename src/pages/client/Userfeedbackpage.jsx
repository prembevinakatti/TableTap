...
function Userfeedbackpage() {
    ...
    return (
        <div className="flex flex-wrap">
            <div className='w-full text-center text-4xl text-gray-600'>your feedbacks and rating</div>
            {reviews.map((singlereview) => (
                ...
                >
                    ...
                    <p
                            className="cursor-pointer text-xl font-semibold text-primary"
                            onClick={() => navigate(`/resprofilepage/${singlereview.resid}`)}
                        >
                           To: {singlereview.resid || "Anonymous"}
                        </p>
                </div>
            ))}
        </div>
